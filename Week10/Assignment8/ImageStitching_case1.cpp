...
int main() {
	...
	int* ptl_x = (int*)malloc(sizeof(int) * cnt);
	int* ptl_y = (int*)malloc(sizeof(int) * cnt);
	int* ptr_x = (int*)malloc(sizeof(int) * cnt);
	int* ptr_y = (int*)malloc(sizeof(int) * cnt);
	...
	Mat A12 = cal_affine<float>(ptl_x, ptl_y, ptr_x, ptr_y, cnt);
	Mat A21 = cal_affine<float>(ptr_x, ptr_y, ptl_x, ptl_y, cnt);
